...
interface MediaListViewProps {
  ...
  onMoveToVault?: (mediaId: string, filename: string) => void;
  isVaultMode?: boolean;
}
                ...
                <TableCell>
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-48">
                      ...
                      {!isVaultMode && onMoveToVault && (
                        <DropdownMenuItem
                          onClick={(e) => {
                            e.stopPropagation();
                            onMoveToVault(file.id, file.originalName);
                          }}
                          data-testid={`action-move-to-vault-${index}`}
                        >
