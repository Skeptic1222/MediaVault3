    ...
    onError: (error: any) => {
      ...
      toast({
        ...
        description: fileCount
          ? `Cannot delete folder with ${fileCount} file(s). Please move or delete all files first.`
          : errorMessage,
        variant: "destructive",
      });
      setDeleteDialogOpen(false);
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-2xl max-h-[80vh] flex flex-col" data-testid="manage-categories-dialog">
          <DialogHeader>
            ...
            <DialogDescription>
              Create, edit, or delete folders to organize your media collection.
            </DialogDescription>
          </DialogHeader>
            ...
            {showNewCategoryForm ? (
              <div className="border rounded-lg p-4 mb-4 bg-secondary/20" data-testid="new-category-form">
                <div className="space-y-3">
                  <div>
                    <Label htmlFor="new-category-name">Folder Name</Label>
                    <Input
                  ...
                  <div>
                    <Label htmlFor="parent-category">Parent Folder (Optional)</Label>
                    <select
                      id="parent-category"
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {categoryToDelete && categoryToDelete.fileCount > 0 ? (
                ...
                <>
                  Are you sure you want to delete the folder "{categoryToDelete?.name}"?
