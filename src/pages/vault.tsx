...
export default function Vault() {
  ...
  // Get media files array for lightbox
  const vaultMediaFiles = vaultMedia?.files || [];
  ...
  const {
    ...
    navigateNext,
    navigatePrevious,
  } = useKeyboardNavigation(vaultMediaFiles);
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {isVaultUnlocked ? (
            <div data-testid="vault-content">
              ...
              ) : vaultMediaFiles.length > 0 ? (
                <MediaGrid
                  mediaFiles={vaultMediaFiles}
                  isLoading={false}
      ...
      {/* Media Lightbox for viewing encrypted content */}
      <MediaLightbox
        mediaFiles={vaultMediaFiles}
        selectedIndex={selectedIndex}
